<x-modal :name="'createLands'" maxWidth="2xl">
    <div class="p-6 space-y-6">
        ...
        <div>
            ...
            @if ($this->form->lands->isEmpty())
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Nenhum terrenos cadastrado ainda.
                </p>
            @else
                <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                    @foreach ($this->form->lands as $land)
        ...
        @if ($showInput)
            <x-secondary-button
                ...
                class="w-full border text-red-500 border-red-500 bg-transparent flex justify-center items-center gap-2">
            ...
            <form wire:submit.prevent="{{ $editingId ? 'update' : 'save' }}" class="space-y-4">
                ...
                <div>
                    ...
                    <x-primary-button type="button" wire:click="addCoordinate"
                                      class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 gap-1">
                ...
                <!-- Seção para selecionar o quarteirão -->
                <div>
                    <x-input-label for="block" value="Selecione o Quarteirão" />
                    <select wire:model.defer="form.block_id" id="block" class="w-full border-gray-300 rounded-md shadow-sm">
                ...
                <div class="flex justify-end space-x-3">
                    <x-cancel-button wire:click="toggleInput" class="flex items-center gap-2 border border-red-800 text-red-500">
                        <x-cancel-icon width="16px" height="16px" color="currentColor"/>
                        Cancelar
                    </x-cancel-button>
                    <x-primary-button type="submit" class="flex items-center gap-2 bg-green-600 hover:bg-green-500">
                        <x-save-icon width="16px" height="16px" color="currentColor" wire:click="save"/>
                        Salvar
                    </x-primary-button>
                </div>
            </form>
